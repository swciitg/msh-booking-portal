...
urlpatterns = [
    ...
    path('download_excel/<int:num>/<str:Hostel>/<str:roll>/<str:sort>/<str:date>/', views.Download_Excel, name='download_excel'),
    ...
    # path('admin-view/invited/',views.AdminInvited,name='admin-invited'),
    # path('admin-view/not-invited/',views.AdminNotInvited,name='admin-not-invited'),
